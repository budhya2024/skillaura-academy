...
const SLIDES: SlideData[] = [
  {
    id: 1,
    tagline: "WELCOME TO SKILL AURA ACADEMY!",
    titlePrefix: "Start Your Beautiful And ",
    titleHighlight: "Bright",
    titleSuffix: " Future",
    description:
      "Master in-demand skills in AI, Graphic Design, Video Editing, and Content Creation with live practical mentorship designed for Indian tech professionals and creators.",
  ...
  {
    id: 2,
    tagline: "EMPOWER YOUR CAREER!",
    titlePrefix: "Unlock World Class ",
    titleHighlight: "Global",
    titleSuffix: " Education",
    description:
      "Join over 25,000+ successful Indian students & freelancers who transformed their careers with accredited masterclasses, job-ready portfolios, and 1-on-1 industry mentorship.",
    bgImage: "/images/hero2.jpg",
    primaryBtnText: "DISCOVER COURSES",
          ...
          {SLIDES.map((slide, index) => {
            ...
            return (
              ...
              >
                ...
                {/* CTA Action Buttons Always in Flex Row */}
                <div className="flex flex-row items-center justify-start gap-2.5 sm:gap-4 pt-2">
                  {/* Primary Orange Button */}
                  <Link
                    href={slide.primaryBtnHref}
                    className="inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-[#FDA31B] hover:bg-[#116E63] text-white font-extrabold text-[11px] sm:text-sm tracking-wider sm:tracking-[0.15em] uppercase px-4 sm:px-8 py-3 sm:py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 whitespace-nowrap cursor-pointer"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-white hover:bg-[#FDA31B] text-[#19232B] hover:text-white font-extrabold text-[11px] sm:text-sm tracking-wider sm:tracking-[0.15em] uppercase px-4 sm:px-8 py-3 sm:py-4 rounded-full shadow-md hover:shadow-lg transition-all duration-300 whitespace-nowrap cursor-pointer"
                  >
