...
export const SEARCH_COURSES: CourseSearchItem[] = [
  {
    ...
    price: "₹4,999",
    keywords: ["video", "editing", "inshot", "capcut", "alight motion", "premiere pro", "vn editing", "reels", "youtube"],
  },
  {
    id: 2,
    ...
    price: "₹3,499",
    keywords: ["design", "poster", "logo", "canva", "photoshop", "illustrator", "pixellab", "photoroom", "branding", "graphics"],
  },
  {
    id: 3,
    ...
    price: "₹4,499",
    keywords: ["content", "creation", "instagram", "growth", "youtube", "ideas", "script writing", "viral", "reels"],
  },
  {
    id: 4,
    ...
    price: "₹3,499",
    keywords: ["knowledge", "affiliate marketing", "personality development", "confidence", "public speaking", "passive income"],
  },
  {
    id: 5,
    ...
    price: "₹4,999",
    keywords: ["business", "problem solving", "sales", "closing", "objection handling", "negotiation", "selling", "high ticket"],
  },
  {
    id: 6,
    ...
    price: "₹3,999",
    keywords: ["facebook ads", "meta ads", "instagram ads", "pixel", "targeting", "performance marketing", "roas", "campaign"],
  },
  {
    id: 7,
    ...
    price: "₹3,999",
    keywords: ["google ads", "youtube ads", "search ads", "pmax", "keywords", "conversion tracking", "ppc", "sem"],
  },
];
